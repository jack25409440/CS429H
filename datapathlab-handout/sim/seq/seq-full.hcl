...
## for iaddl (IIADDL), leave (ILEAVE) and mrimovl(IMRIMOVL).
...
intsig IPOPL	'I_POPL'
# Instruction coicode in { ILEAVE } : REBPde for iaddl instruction
intsig IIADDL	'I_IADDL'
# Instruction code for leave instruction
intsig ILEAVE	'I_LEAVE'
# Instruction code for mrimovl instruction
intsig IMRIMOVL	'I_MRIMOVL'
...
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	       IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL, ILEAVE, IMRIMOVL};

# Does fetched instruction require a regid byte?
bool need_regids =
	icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, IIADDL, IMRIMOVL};

# Does fetched instruction require a constant word?
bool need_valC =
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IIADDL, IMRIMOVL };
...
int srcB = [
	icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL, IMRIMOVL } : rB;
...
int dstE = [
	...
	icode in { IIRMOVL, IOPL, IIADDL, IMRIMOVL } : rB;
	icode in { IPUSHL, IPOPL, ICALL, IRET, ILEAVE } : RESP;
        ##icode in { IMRIMOVL } : rA;
	1 : RNONE;  # Don't write any register
];

## What register should be used as the M destination?
int dstM = [
	icode in { IMRMOVL, IPOPL, IMRIMOVL } : rA;
        icode in { ILEAVE } : REBP;
        ##icode in { IMRIMOVL } : rB;
	1 : RNONE;  # Don't write any register
];
...
int aluA = [
	...
	icode in { IRET, IPOPL, ILEAVE, IMRIMOVL } : 4;
...
int aluB = [
	icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		      IPUSHL, IRET, IPOPL, IIADDL, ILEAVE, IMRIMOVL } : valB;
...
bool mem_read = icode in { IMRMOVL, IPOPL, IRET, ILEAVE, IMRIMOVL };
